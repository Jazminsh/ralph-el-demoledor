...
function preload(){
backgroundImg = loadImage("assets/back22.png");
...
//sistema de Colisiones
    ...
    plataformas[0].rotation = angulo;
    plataformas[1].rotation = angulo;
    plataformas[2].rotation = angulo;
